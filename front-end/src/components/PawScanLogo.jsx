...
const PawScanLogo = ({text= true, textColor="ffffff"}) => {
  return (
    <div className="flex items-center space-x-2">
        {/* SVG Logo with subtle bounce animation and hover effect */}
        <svg
        ...
        {/* Text with specified color */}
        {text &&
        <span className={`text-2xl font-bold text-[#${textColor}]`}>PawScan</span>}
    </div>
  );
};
